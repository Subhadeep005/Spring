			...
			<div class="container">
					<div class="row">
						...
						<div class="col-md-8">
								...
								<form:form modelAttribute="customerDto" cssClass="form-group" action="${registerUrl }" method="post">
								
									<c:if test="${customerDto.id ne null}">
						...
						<div Class="form-group">
							...
							<c:if test="${customerDto.id eq null}">
