	...
	<!-- Starts -->
		...
		<!-- Contact Form Starts -->
			<div class="col-sm-8">
				<div class="panel panel-smart">
					<div class="panel-heading">
						<h3 class="panel-title">Send us a mail &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<c:if test="${contactId != null}">
						<span style="color:green; padding-left: 50px" id="contact_response">Reference Number : ${contactId}</span>
						</c:if>
						</h3>
					</div>
					<div class="panel-body">
						<form:form class="form-horizontal" role="form" modelAttribute="contactus" method="POST">
							<div class="form-group">
								...
								<div class="col-sm-10">
									...
									<span><b><form:errors path="name" cssClass="error" /></b></span>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									...
									<span><b><form:errors path="email" cssClass="error" /></b></span>
								</div>
							</div>
							<div class="form-group">
								...
								<span><b><form:errors path="subject" cssClass="error" /></b></span>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									...
									<span><b><form:errors path="message" cssClass="error" /></b></span>
								</div>
							</div>
							<div class="form-group">
